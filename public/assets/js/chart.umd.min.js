...
!(function (t, e) {
    ...
    class Vs {
        ...
        getMinMax(t, e) {
            const i = this._cachedMeta,
                ...
                l = ((t, e, i) =>
                    t &&
                    !e.hidden &&
                    e._stacked && { keys: Cs(i, !0), values: null })(
                    e,
                    i,
                    this.chart
                ),
        ...
        _resolveElementOptions(t, e = "default", i) {
            ...
            return (
                f.$shared &&
                    ((f.$shared = r), (n[o] = Object.freeze(Fs(f, r)))),
                f
            );
        }
    ...
    class Ks extends Bs {
        ...
        fit() {
            ...
            if (o) {
                ...
                if (
                    (a
                        ? ((t.width = this.maxWidth), (t.height = Us(n) + o))
                        : ((t.height = this.maxHeight), (t.width = Us(n) + o)),
    ...
    function pn(t, e) {
        return (
            "top" === t || "bottom" === t || (-1 === gn.indexOf(t) && "x" === e)
        );
    }
    function mn(t, e) {
        return function (i, s) {
            ...
            e &&
                ...
                u(n, (e) => {
                    const n = e.options,
                        ...
                        r = l(n.type, e.dtype);
                    (void 0 !== n.position &&
                        pn(n.position, a) === pn(e.dposition)) ||
    ...
    class Zn extends Bs {
        ...
        get segments() {
            return (
                this._segments ||
                (this._segments = Ri(this, this.options.segment))
            );
        }
        first() {
        ...
        draw(t, e, i, s) {
            ...
            (this.points || []).length &&
                n.borderWidth &&
                (t.save(), Gn(t, this, i, s), t.restore()),
                this.animated &&
            ...
            const n = (function (t, e) {
                ...
                for (
                    ...
                    (u && M !== a
                        ? (i.push({ value: a }),
                          M < a && D++,
                          V(Math.round((M + D * S) * v) / v, a, lo(a, y, t)) &&
                              D++)
                        : M < a && D++);
                    D < k;
                    ++D
                ...
                return (
                    x && u && w !== r
                        ? i.length && V(i[i.length - 1].value, r, lo(r, y, t))
    ...
    function mo(t, { min: e, max: i }) {
        ...
        for (; f < i; )
            s.push({ value: f, major: go(f), significand: u }),
                u >= 10 ? (u = u < 15 ? 15 : 20) : u++,
    ...
    class bo extends Ks {
        ...
        handleTickRangeOptions() {
            ...
            const n = (e) => (i = t ? i : e),
                o = (t) => (s = e ? s : t);
            i === s && (i <= 0 ? (n(1), o(10)) : (n(fo(i, -1)), o(fo(s, 1)))),
                i <= 0 && n(fo(s, -1)),
                s <= 0 && o(fo(i, 1)),
                (this.min = i),
                (this.max = s);
            ...
            return (
                ...
                (this._majorUnit =
                    i.major.enabled && "year" !== this._unit
                        ? (function (t) {
                              for (
                                  let e = Co.indexOf(t) + 1, i = Co.length;
                                  e < i;
                                  ++e
                              )
                                  if (Do[Co[e]].common) return Co[e];
                          })(this._unit)
                        : void 0),
                this.initOffsets(s),
                t.reverse && o.reverse(),
            ...
            parse(t, e) {
                ...
                return ((t, e) => (null === t ? null : J(Math.round(t), 0, e)))(
                    (e =
                        isFinite(e) && i[e] === t
                            ? e
                            : ao(i, t, l(e, t), this._addedLabels)),
                    i.length - 1
                );
            }
            determineDataLimits() {
            ...
            (function (t, e) {
                ...
                t.save(),
                    "x" === l &&
                        ...
                        t.save(),
                        oa(t, s, a.bottom));
                aa(t, { line: i, target: s, color: o, scale: r, property: l }),
                    t.restore();
            })(t, {
                line: n,
                target: s,
                    ...
                    for (const e of h) {
                        ...
                        for (const t of r)
                            a.push({
                                source: t,
                                target: e,
                                start: { [i]: Ko(l, s, "start", Math.max) },
                                end: { [i]: Ko(l, s, "end", Math.min) },
                            });
                    }
                }
                return a;
    ...
    class Ta extends Bs {
        ...
        getTitle(t, e) {
            ...
            let a = [];
            return (
                (a = _a(a, ya(s))), (a = _a(a, ya(n))), (a = _a(a, ya(o))), a
            );
        }
        getBeforeBody(t, e) {
